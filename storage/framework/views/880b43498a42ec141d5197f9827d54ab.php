<?php $__env->startSection('title', 'Tabel Informasi - BUSTAT LAMPUNG'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tabel-terminal').DataTable({
                processing: true,
                ajax: '<?php echo e(route("terminals.json")); ?>', // Mengambil data dari route API
                columns: [
                    { data: 'id' },
                    { data: 'nama_terminal' },
                    { data: 'alamat' },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bustat-lampung\resources\views/tabel.blade.php ENDPATH**/ ?>